...
import com.airline.service.FlightLocal_ejb9;
...
public class FlightDetails extends HttpServlet {
	...
	private FlightLocal_ejb9 fs;
	//private FlightService fs = null;
	
	@EJB(beanName = "statelessBean")
	private FlightLocal_ejb9 fs2;
	
	@EJB(beanName = "statefulBean")
	private FlightLocal_ejb9 fsStateful;
	
	@EJB(beanName = "statefulBean")
	private FlightLocal_ejb9 fsStateful2;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		fs2.setAirlaneModel("test model");
		
		out.println(fs.getAirlaneModel());
		out.println(fs2.getAirlaneModel());
		
		out.println("---------------------------------------------");
		
		out.println(fsStateful.getAirlaneModel());
		
		fsStateful2.setAirlaneModel("test stateful model");
		
		out.println(fsStateful.getAirlaneModel());
		out.println(fsStateful2.getAirlaneModel());
