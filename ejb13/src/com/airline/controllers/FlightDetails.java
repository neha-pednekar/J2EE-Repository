...
public class FlightDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			Object fsObj = context.lookup("java:global/ejb10/statelessBean!com.airline.service.FlightLocal_ejb10");
			fs = (FlightLocal_ejb13) fsObj;
		} catch (NamingException e) {
			// TODO Auto-generated catch block
			out.println("A naming exception has occured while looking up for stateless bean");
			e.printStackTrace();
		}
		...
		try {
			Context context = new InitialContext();
			Object fsStatefulObj = context.lookup("java:global/ejb10/statefulBean!com.airline.service.FlightLocal_ejb10");
			fsStateful = (FlightLocal_ejb13) fsStatefulObj;
		} catch (NamingException e) {
			// TODO Auto-generated catch block
			out.println("A naming exception has occured while looking up for stateful bean");
			e.printStackTrace();
		}
